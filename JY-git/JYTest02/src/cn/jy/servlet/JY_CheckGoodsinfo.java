...
public class JY_CheckGoodsinfo extends HttpServlet {
	...
	private String sOperType, gid, bid, gname, boxid, boxsize, boxkind, leadnumber, gunit, sql, tmp, sResult = "fail";

	private int gcount;
	private double gtotalweight, glength, gwidth, gheight, gvolume;
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		case 2:
			...
			sql = "insert into goodsinfo(bid,gid,gname,boxid, boxsize,boxkind,leadnumber,gunit,gcount,gtotalweight,glength,gheight,gwidth,gvolume) "
					+ "values(" + "'" + bid + "'," + "'" + gid + "'," + "'" + gname + "'," + "" + boxid + "," + "'"
					+ boxsize + "'," + "'" + boxkind + "'," + "'" + leadnumber + "'," + "'" + gunit + "'," + "" + gcount
					+ "," + "'" + gtotalweight + "'," + "'" + glength + "'," + "'" + gheight + "'," + "'" + gwidth
					+ "'," + "'" + gvolume + "')";
		...
		case 3:
			...
			sql = "update goodsinfo " + "set gname='" + gname + "'," + "boxid=" + boxid + "," + "boxsize='" + boxsize
					+ "'," + "boxkind='" + boxkind + "'," + "leadnumber=" + leadnumber + "," + "gunit='" + gunit + "',"
					+ "gcount='" + gcount + "'," + "gtotalweight=" + gtotalweight + "," + "glength='" + glength + "',"
					+ "gheight='" + gheight + "'," + "gwidth=" + gwidth + "," + "gvolume='" + gvolume + "' "
					+ "where gid='" + gid + "'";
