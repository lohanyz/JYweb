...
public class JY_CheckBoxmanageinfo extends HttpServlet {
	...
	private String bid, gid, wid, getboxspace, getboxtime, backchnportime, backportstorehoustime, portranstime,
			transtid, downlineovertime, railwaydownlinetime, fbacknulltime, state, simg, img;
	private int bmid;
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		case 1:
			...
			// getboxspace = new
			// String(req.getParameter("getboxspace").getBytes("ISO8859_1"),"utf-8");
			// getboxtime = new
			// String(req.getParameter("getboxtime").getBytes("ISO8859_1"),"utf-8");
			// backchnportime = new
			// String(req.getParameter("backchnportime").getBytes("ISO8859_1"),"utf-8");
			// backportstorehoustime = new
			// String(req.getParameter("backportstorehoustime").getBytes("ISO8859_1"),"utf-8");
			// portranstime = new
			// String(req.getParameter("portranstime").getBytes("ISO8859_1"),"utf-8");
			// transtid = new
			// String(req.getParameter("transtid").getBytes("ISO8859_1"),"utf-8");
			// downlineovertime = new
			// String(req.getParameter("downlineovertime").getBytes("ISO8859_1"),"utf-8");
			// railwaydownlinetime = new
			// String(req.getParameter("railwaydownlinetime").getBytes("ISO8859_1"),"utf-8");
			// fbacknulltime = new
			// String(req.getParameter("fbacknulltime").getBytes("ISO8859_1"),"utf-8");
			...
			obja.put("ecarryaddress", "getboxspace");
			obja.put("ecarrydate", "getboxtime");
			obja.put("echinaporttime", "backchnportime");
			obja.put("eportstorageroomtime", "backportstorehoustime");
			obja.put("etimechangeofport", "portranstime");
			obja.put("echangenumber", "transtid");
			obja.put("efeeofflinetime", "downlineovertime");
			obja.put("erailwayofflinetime", "railwaydownlinetime");
			obja.put("eactualreturntime", "fbacknulltime");
			obja.put("cargostatusbox", "state");
			objb.put("barcode", bid);
			objb.put("body", obja);
			System.out.println(objb.toString());
			obja = JSONObject.fromObject(bas.saveBoxGoods(objb.toString()));
			if (obja.get("Head").equals("0000")) {
				sql = "insert into boxmanageinfo(bid,gid,getboxspace, getboxtime, backchnportime, backportstorehoustime,portranstime, transtid, downlineovertime,railwaydownlinetime,fbacknulltime,state,simg, img ) "
						+ "values(" + "'" + bid + "'," + "'" + gid + "'," + "'" + getboxspace + "'," + "'" + getboxtime
						+ "'," + "'" + backchnportime + "'," + "'" + backportstorehoustime + "'," + "'" + portranstime
						+ "'," + "'" + transtid + "'," + "'" + downlineovertime + "'," + "'" + railwaydownlinetime
		...
		case 3:
			...
			backportstorehoustime = new String(req.getParameter("backportstorehoustime").getBytes("ISO8859_1"),
					"utf-8");
			...
			sql = "update boxmanageinfo " + "set getboxspace='" + getboxspace + "'," + "getboxtime='" + getboxtime
					+ "'," + "backchnportime='" + backchnportime + "'," + "backportstorehoustime='"
					+ backportstorehoustime + "'," + "portranstime='" + portranstime + "'," + "transtid='" + transtid
					+ "'," + "downlineovertime='" + downlineovertime + "'," + "railwaydownlinetime='"
					+ railwaydownlinetime + "'," + "fbacknulltime='" + fbacknulltime + "'," + "state='" + state + "',"
					+ "simg='" + simg + "'," + "img='" + img + "' "
