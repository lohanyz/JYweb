...
public class JY_Boxmanage extends HttpServlet{
	private static final long serialVersionUID = 1L;
	private String 		bid, getboxspace, getboxtime, backchnportime, backportstorehoustime, 
...
// bid, getboxspace, getboxtime, backchnportime, backportstorehoustime portranstime, transtid, downlineovertime,railwaydownlinetime,fbacknulltime,state,simg, img,bmid;
	...
	private ArrayList<Boxmanageinfo> boxmanagelist;
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		case 1:
			...
			sql			=	"select * from boxmanageinfo where bid='"+bid+"'";
			boxmanagelist		=	dbTool.doDBQueryBoxmanageinfo(sql);
			session.setAttribute("listBoxmanage", boxmanagelist.get(0));
			
			sResult		=	"boxmanage/boxmanage_info.jsp";
			break;
