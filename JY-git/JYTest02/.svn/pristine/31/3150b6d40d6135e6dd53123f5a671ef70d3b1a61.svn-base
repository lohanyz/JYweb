...
public class JY_Port extends HttpServlet{
	private static final long serialVersionUID = 1L;
	private String 		bid,inporttime,ctime,intime, pboxtime,state,simg,lkind,reporttime,classorderid,tid,tkind,oid,gtime,stime;
	private int 		pid,pertcount,tcount;
	private boolean 	islean;
	private double 		pertweight,tformatweight;
	
	//bid,inporttime,ctime,intime, pboxtime,state,simg,lkind,reporttime,classorderid,tid,tkind,oid,gtime,stime,pid,pertcount,tcount
	...
	private ArrayList<Portinfo> portlist;
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		case 1:
			...
			sql			=	"select * from portinfo where bid='"+bid+"'";
			portlist		=	dbTool.doDBQueryPortinfo(sql);
			session.setAttribute("listPort", portlist.get(0));
			
			sResult		=	"port/port_info.jsp";
			break;
