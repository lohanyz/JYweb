...
public class JY_Harbor extends HttpServlet{
	private static final long serialVersionUID = 1L;
	private String 		bid,state,simg,ftochnharbortime, pboxtime,senttime,transtime,transtid,stime;
	private int 		hid,transtcount,pertcount;
	...
	private ArrayList<Harborinfo> harborlist;
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		case 1:
			...
			sql			=	"select * from Harborinfo where bid='"+bid+"'";
			harborlist		=	dbTool.doDBQueryHarborinfo(sql);
			session.setAttribute("listHarbor", harborlist.get(0));
			
			sResult		=	"harbor/harbor_info.jsp";
			break;
